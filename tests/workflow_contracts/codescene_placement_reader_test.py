...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "leynos/corbusier/.github/workflows/release.yml@main",
            None,
            id="qualified-self",
        ),
        pytest.param(
        ...
        textwrap.dedent(
            ...
            jobs:
              ...
              named:
                ...
                secrets: {X: y}
              self-by-ref:
                uses: leynos/corbusier/.github/workflows/a.yml@main
                secrets: inherit
            """
        )
    )
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "leynos/corbusier/.github/workflows/x.yml@main",
            True,
            id="qualified",
        ),
        pytest.param(
            "Leynos/Corbusier/.github/workflows/x.yml@v1",
            True,
            id="qualified-case",
        ),
        pytest.param("./.github/workflows/x.yml", False, id="local"),
        pytest.param(
            "leynos/corbusier/.github/workflows/x.yml", False, id="no-ref"
        ),
        pytest.param(
            "leynos/corbusier-fork/.github/workflows/x.yml@main",
            False,
            id="similar-name",
        ),
        pytest.param(
        ...
        pytest.param(
            "leynos/corbusier/.github/actions/setup@main",
            False,
            id="own-action",
        ),
        pytest.param(
...
def test_callers_by_ref_are_listed() -> None:
    ...
    document = load_workflow(
        ...
        "  pinned: {uses: leynos/corbusier/.github/workflows/a.yml@main}\n"
    )
